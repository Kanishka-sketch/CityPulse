function Navbar() {
  return (
    <header className="navbar">
      ...
      <div className="navbar-right"><span className="location"><span aria-hidden="true">⌖</span> Jaipur</span><span className="connection-status"><span className="pending-dot" /> Preview mode</span></div>
    </header>
  );
}
